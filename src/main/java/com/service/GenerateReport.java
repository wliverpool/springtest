...
import com.pojo.CruiseServiceLocation;

public class GenerateReport {
	
	private static String fileName = "C:\\exceltest.xls";
	...
	static {
		...
		csl[1] = new CruiseServiceLocation("T001", "北京市", "北京总部", "bj", "北京大学",
				30);
		// csl[2] = new CruiseServiceLocation("T001", "北京市", "北京总部", "bj",
		// "天安门",
		// 40);
		...
		csl[3] = new CruiseServiceLocation("T001", "北京市", "海淀经销商", "bjhd",
				"首都机场", 50);
		csl[4] = new CruiseServiceLocation("T001", "北京市", "海淀经销商", "bjhd",
				"中关村", 23);
		// csl[6] = new CruiseServiceLocation("T001", "北京市", "东城经销商", "bjdc",
		// "前门", 8);
		csl[5] = new CruiseServiceLocation("T001", "北京市", "东城经销商", "bjdc",
				"北京火车站", 4);
		csl[6] = new CruiseServiceLocation("T001", "北京市", "东城经销商", "bjdc",
				"北京西站", 12);
		...
		csl[9] = new CruiseServiceLocation("T001", "辽宁省", "大连经销商", "lndl",
				"高新园区信达街", 11);
		csl[10] = new CruiseServiceLocation("T001", "辽宁省", "大连第二经销商", "lndl2",
				"数码广场", 8);
		csl[11] = new CruiseServiceLocation("T001", "辽宁省", "大连第二经销商", "lndl2",
				"马栏广场", 17);
		csl[12] = new CruiseServiceLocation("T001", "辽宁省", "大连第二经销商", "lndl2",
				"五一广场", 12);
		csl[13] = new CruiseServiceLocation("T001", "辽宁省", "沈阳经销商", "lnsy",
				"沈阳故宫", 16);
		csl[14] = new CruiseServiceLocation("T001", "辽宁省", "沈阳经销商", "lnsy",
				"沈阳北站", 4);
		csl[15] = new CruiseServiceLocation("T001", "吉林省", "长春经销商", "jlcc",
				"吉林大学", 4);
		csl[16] = new CruiseServiceLocation("T001", "吉林省", "长春经销商", "jlcc",
				"长春火车站", 4);
		csl[17] = new CruiseServiceLocation("T002", "黑龙江省", "哈尔滨经销商", "hljhrb",
				"哈工大", 12);
		csl[18] = new CruiseServiceLocation("T002", "黑龙江省", "齐齐哈尔经销商",
				"hljqqhr", "火车站", 21);
